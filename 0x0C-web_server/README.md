# Web server
Project done during **Full Stack Software Engineering studies** at **ALX-Holberton School**. It aims to learn about the roles of web servers and their processes (parent and child), and DNS roles.
